...
namespace Lurchsoft.ParallelWorkshop.Ex07DiyLazy
{
    ...
    /// (1) a lazy with the behaviour of <see cref="LazyThreadSafetyMode.PublicationOnly"/>. For this one, you definitely
    /// do not need any locks, just <see cref="Interlocked"/>.
    /// (2) a lazy with the behaviour of <see cref="LazyThreadSafetyMode.ExecutionAndPublication"/>. For this one, you can
    /// try: -
